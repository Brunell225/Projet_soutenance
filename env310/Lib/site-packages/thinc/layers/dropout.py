...
#Ceci est la structure backend du bot, Mais le bot n'interragit pas, il ne repond pas aux messages correctement des cleints sur whatsapp business pour le vendeur malgrés que le message est claire et detectable, il dit toujours qu'il ne comprend pas et il demande une reformulation. Et meme dans l'application dans la partie tester mon bot lorsque les vendeurs souhaitent tester leurs bot en entament une causerie, il dit toujours qu'il ne comprend pas malgrés que les messages sont très claire et detectables du coups je ne sais plus comment m'y prendre pour qu'il puisse entamé une causerie, c'est  a dire pouvoir repondre clairement et bien interagir 
